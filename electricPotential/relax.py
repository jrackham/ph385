...
omega = [0, 0.1, 0.15, 0.2, 0.25, 0.3, 0.35, 0.4, 0.45, 0.5, 0.55, 
         0.6, 0.65, 0.7, 0.75, 0.8, 0.85, 0.9, 0.95, 0.99]
#omega = np.linspace(0.8, 0.95, 15)
conv = []

for o in omega:
    mesh1, num = relaxMesh(30, 30, 0.001, o)
    conv.append(num)

# Plotting stuff
#pyl.pcolormesh(mesh1)
pyl.plot(omega, conv)
pyl.title("Omega Parameter Optimization")
pyl.ylabel("Number of Iterations")
pyl.xlabel("Omega Parameter")
pyl.show()
